...
<head>
  ...
  <link href="<?php echo e(asset('admin/vendor/datatables/buttons.dataTables.min.css')); ?>" rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark sidenav-toggled" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo e(route('/')); ?>">CMS ITCM</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Blog">
          <a class="nav-link" href="<?php echo e(url('posts')); ?>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Kategori">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti">
            <li>
              <!-- <a href="<?php echo e(route('faq')); ?>">Kategori Blog</a> -->
            </li>
            <li>
              <a href="<?php echo e(route('category-faqs')); ?>">Kategori FAQ</a>
            </li>
            <li>
              <a href="<?php echo e(url('categories')); ?>">Kategori Blogs</a>
            </li>
            <!-- <li>
              <a href="<?php echo e(url('tags')); ?>">Tags</a>
            </li> -->
          </ul>
        </li>
      </ul>
  ...
  <div class="content-wrapper">
    ...
    <script src="<?php echo e(asset('admin/js/sb-admin.min.js')); ?>"></script>
    <!-- Custom scripts for this page-->
    <script src="<?php echo e(asset('admin/js/sb-admin-datatables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/js/sb-admin-datatables.buttons.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('admin/vendor/bootstrap-select/dist/js/i18n/defaults-en_US.min.js')); ?>"></script>
