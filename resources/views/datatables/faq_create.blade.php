...
<p class="lead">Create and save this faqs below, or <a href="{{ route('faq') }}">go back to all Faqs.</a></p>
<hr>
...
{!! Form::model($faqs, ['method' => 'POST', 'route' => ['faq.store']]) !!}

<div class="form-group">
    {!! Form::label('title', 'Category Name:', ['class' => 'control-label']) !!}
    {!! Form::select('category_name', $items, null, ['class' => 'form-control', 'id' => 'category', 'onchange' => 'changeDropdown(this.value, "category", "sub_category", false)']) !!}
</div>
