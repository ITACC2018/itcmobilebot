...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="card-body">
        <?php echo Form::model($faqs, ['method' => 'POST', 'route' => ['categoryfaqs.store']]); ?>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('category_name', null, ['class' => 'form-control', 'id' => 'category_name_1']); ?>
        ...
        <?php echo Form::model($faqs, ['method' => 'POST', 'route' => ['categoryfaqs.store']]); ?>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::select('category_name',  $category, null, ['class' => 'selectpicker form-control', 'id' => 'category_name_2', 'data-live-search' => 'true', 'title'=>' -- PILIH --']); ?> 
                </div>
                <div class="form-group">
                    <?php echo Form::label('title', 'Sub Category:', ['class' => 'control-label']); ?>

                    <?php echo Form::text('sub_category_name', null, ['class' => 'form-control']); ?>

                </div>
            <?php echo Form::submit('Create Sub Category', ['class' => 'btn btn-primary']); ?>
    ...
    <div class="col-md-4">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <?php echo Form::select('category_name', $category, null, ['class' => 'form-control selectpicker', 'id' => 'category_name_3', 'data-live-search' => 'true', 'title'=>' -- PILIH --']); ?>
            ...
            <div class="form-group">
                ...
                <?php echo Form::select('sub_category_name', [], null, ['class' => 'form-control selectpicker', 'id' => 'sub_category_name_3', 'data-live-search' => 'true', 'title'=>' -- PILIH --']); ?>
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('sub_sub_category_name', null, ['class' => 'form-control']); ?>

            </div>
        <?php echo Form::submit('Create Sub Sub Category', ['class' => 'btn btn-primary']); ?>
...
$(function() {
    ...
    $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('/category-faqs/datatables')); ?>",
        columns: [
