...
<p class="lead">Edit and save this faqs below, or <a href="<?php echo e(route('faq')); ?>">go back to all Faqs.</a></p>
<hr>
...
<?php echo Form::model($faqs, ['method' => 'PATCH', 'route' => ['faq.update', $faqs->id]]); ?>


<div class="form-group">
    <?php echo Form::label('title', 'Category Name:', ['class' => 'control-label']); ?>

    <?php echo Form::select('category_name', $items, $faqs->category_id, ['class' => 'form-control', 'id' => 'category', 'onchange' => 'changeDropdown(this.value, "category", "sub_category", false)']); ?>
...
<script>
    ...
    <?php if(!empty($faqs->category_id)): ?>
        changeDropdown('<?php echo e($faqs->category_id); ?>', 'category', 'sub_category', true);
    <?php endif; ?>
    <?php if(!empty($faqs->sub_category_id)): ?>
        changeDropdown('<?php echo e($faqs->sub_category_id); ?>', 'sub_category', 'sub_sub_category', true);
    <?php endif; ?>
    ...
    function buildDropdown(result, dropdown, emptyMessage, elId, status) {
        ...
        if(status == true){
            <?php if(!empty($faqs->sub_category_id)): ?>
                $('#sub_category').val('<?php echo e($faqs->sub_category_id); ?>');
            <?php endif; ?>
            <?php if(!empty($faqs->sub_sub_category_id)): ?>
                $('#sub_sub_category').val('<?php echo e($faqs->sub_sub_category_id); ?>');
            <?php endif; ?>
        }
    }
